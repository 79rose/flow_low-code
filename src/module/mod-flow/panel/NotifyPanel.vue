<script setup lang="ts">
    import type { NotifyNode, Field } from '../node/type'
...
<template>
    <el-form label-position="top" label-width="90px">
        ...
        <el-form-item prop="subject" label="消息主题">
            ...
            <el-input v-model="activeData.subject" :maxlength="255" clearable placeholder="请输入消息主题" />
        </el-form-item>
        <el-form-item prop="content" label="消息内容">
            ...
            <el-input v-model="activeData.content" :autosize="{ minRows: 6, maxRows: 8 }" type="textarea"
                :maxlength="1000" show-word-limit placeholder="请输入消息内容">
            </el-input>
        </el-form-item>
    </el-form>
</template>
