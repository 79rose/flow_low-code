<script setup lang="ts">
    import type { TimerNode } from '../node/type'
    defineProps<{
...
<template>
    <el-form label-position="top">
        ...
        <el-form-item prop="duration" label="等待时长" v-if="activeData.waitType === 'duration'">
            <el-input v-model.number="activeData.duration" :min="0" :max="9999999" type="number"
                style="max-width: 230px" class="input-with-select">
                <template #append>
        ...
        <el-form-item prop="duration" label="指定时间" v-if="activeData.waitType === 'date'">
            <el-date-picker v-model="activeData.timeDate" type="datetime" format="YYYY-MM-DD HH:mm:ss"
                value-format="YYYY-MM-DD HH:mm:ss" placeholder="请选择等待时间" />
        </el-form-item>
    </el-form>
</template>
